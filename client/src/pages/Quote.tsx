          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Looking for a durable, cost-effective storage solution? Our expert team can help you find the perfect metal shed or building that meets your needs and budget. Fill out our form to get a personalized quote today.
              </p>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Preferred Contact Method</h4>
                ...
                {/* Type of Service */}
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Type of Service</h4>
                  <Select onValueChange={(value) => handleInputChange("serviceType", value)}>
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="Select service type" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="residential-metal-shed">Residential Metal Shed</SelectItem>
                      <SelectItem value="prefab-steel-garage">Prefab Steel Garage</SelectItem>
                      <SelectItem value="agricultural-pole-barn">Agricultural Pole Barn</SelectItem>
                      <SelectItem value="commercial-steel-building">Commercial Steel Building</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                {/* Desired Dimensions */}
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Desired Dimensions</h4>
                ...
                {/* Intended Use */}
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Intended Use</h4>
                ...
                {/* Siding Material */}
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Siding Material</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <input
                      type="text"
                ...
                {/* Window Type */}
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Window Type</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <input
                      type="text"
                ...
                {/* Door Type */}
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Door Type</h4>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-4">Shelving</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-4">Work Bench</h4>
                    <div className="space-y-2">
                      <label className="flex items-center">
                        <input type="checkbox" className="mr-2" />
                        Yes
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">How Did You Hear About Us?</h4>
                  <textarea
                    rows={4}
